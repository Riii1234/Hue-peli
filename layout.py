...
def create_starting_frame(starting_frame, root):
    ...
    player_combobox = create_combobox(starting_frame, player_name, 1, 3, 1, 1, 1, 10)

    player_combobox.bind("<<ComboboxSelected>>", lambda event: make_player_names_combobox(event, player_name, player_combobox))
...
# -------------------------------------------------------------------
def make_player_names_combobox(event, player_name, player_combobox):

    import player_controls

    chosen_name = player_combobox.get()

    player_names = player_controls.player_data_loader()
